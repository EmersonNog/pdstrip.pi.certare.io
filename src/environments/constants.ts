...
export class Constants {
  ...
  public static AUTH_EXT_PAGE = {
    id: "auth-ext",
    name: "AuthExtPage",
    title: "Autenticação",
    icon: "home",
  };
  public static AREAS_EXAMES_PAGE = {
    id: "areas-exames",
    name: "AreasExamesPage",
    title: "Áreas",
    icon: "custom-exames",
  };
  public static LOGIN_PAGE = { id: "login", name: "LoginPage", title: "Login" };
  public static PROFILE_PAGE = {
    id: "profile",
    name: "ProfilePage",
    title: "Perfil",
    icon: "custom-perfil",
  };
  public static PROFILE_EDIT_PAGE = {
    id: "edit",
    name: "ProfileEditPage",
    title: "Editar Perfil",
  };
  public static RECOVERY_PASSWORD_PAGE = {
    id: "recovery-page",
    name: "RecoveryPasswordPage",
    title: "Recuperar Senha",
  };
  public static SIGNUP_PAGE = {
    id: "signup",
    name: "SignupPage",
    title: "Cadastro",
  };
  ...
  public static FILTER_PAGE = {
    id: "filter",
    name: "FilterPage",
    title: "Filtrar",
    icon: "ios-funnel",
  };
  public static USERS_PAGE = {
    id: "users",
    name: "UsersPage",
    title: "Usuários",
    icon: "custom-users",
  };
  public static GROUPS_PAGE = {
    id: "groups",
    name: "GroupsPage",
    title: "Grupos",
    icon: "custom-groups",
  };
  public static IMPORT_DATA_PAGE = {
    id: "import-csv",
    name: "ImportCsvPage",
  ...
  public static PATH_DOCUMENTS_RODOVIA_SRE =
    Constants.PATH_DOCUMENTS_RODOVIA + "sre/";
  public static PATH_DOCUMENTS_RODOVIA_ACIDENTES =
    Constants.PATH_DOCUMENTS_RODOVIA + "acidentes/";
  public static PATH_DOCUMENTS_RODOVIA_DEFENSAS =
    Constants.PATH_DOCUMENTS_RODOVIA + "defensas/";
  public static PATH_DOCUMENTS_RODOVIA_FOTOS =
    Constants.PATH_DOCUMENTS_RODOVIA + "fotos/";
  public static PATH_DOCUMENTS_RODOVIA_PORTICOS =
    Constants.PATH_DOCUMENTS_RODOVIA + "porticos/";
  public static PATH_DOCUMENTS_RODOVIA_SEMIPORTICO =
    Constants.PATH_DOCUMENTS_RODOVIA + "semiportico/";
  public static PATH_DOCUMENTS_RODOVIA_PONTES =
    Constants.PATH_DOCUMENTS_RODOVIA + "pontes/";
  public static PATH_DOCUMENTS_RODOVIA_FOTOSSENSORES =
    Constants.PATH_DOCUMENTS_RODOVIA + "fotossensores/";
  public static PATH_DOCUMENTS_RODOVIA_FAIXADEDOMINIO =
    Constants.PATH_DOCUMENTS_RODOVIA + "faixaDeDominio/";
  public static PATH_DOCUMENTS_RODOVIA_EXAMES =
    Constants.PATH_DOCUMENTS_RODOVIA + "exames/";
  public static PATH_DOCUMENTS_RODOVIA_SINHORIZONTAL =
    Constants.PATH_DOCUMENTS_RODOVIA + "sinalizacaohorizontal/";
  public static PATH_DOCUMENTS_RODOVIA_LIMMUNICIPIO =
    Constants.PATH_DOCUMENTS_RODOVIA + "limiteMunicipio/";
  ...
  public static PATH_DOCUMENTS_FISCALIZACAOELETRONICA =
  ...
  public static PATH_DOCUMENTS_SINALIZACAOHORIZONTAL =
  ...
  public static BASE_URL_FIREBASE_FUNCTIONS = environment.production
    ? "https://us-central1-sistema-onu.cloudfunctions.net"
    : "https://us-central1-sistema-onu.cloudfunctions.net";
